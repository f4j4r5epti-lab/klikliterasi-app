<template>
  <div class="literacy-portal font-sans bg-amber-50/20 min-h-screen text-slate-800 pb-12">
    ...
    <section id="jurnal" class="max-w-4xl mx-auto px-6 py-12">
      ...
      <!-- FEED JURNAL PERMANEN DARI BACKEND API -->
      <div class="space-y-6">
        <!-- Status Loading -->
...
// URL Subdomain API PHP MySQL Resmi Baru
const API_URL = 'https://klikliterasi.sdnpucung.my.id/api.php'
...
// 1. MEMBACA DATA DARI BACKEND API PHP
...
const addComment = async (post) => {
  ...
  const authorName = `Kelas ${selectedClass.value}`
